...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop ManageMyNode server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "ManageMyNode server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ManageMyNode features */
        {"managemynode", "masternode", &masternode, true, true, false},
        {"managemynode", "listmasternodes", &listmasternodes, true, true, false},
        {"managemynode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"managemynode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"managemynode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"managemynode", "masternodedebug", &masternodedebug, true, true, false},
        {"managemynode", "startmasternode", &startmasternode, true, true, false},
        {"managemynode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"managemynode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"managemynode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"managemynode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"managemynode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"managemynode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"managemynode", "mnbudget", &mnbudget, true, true, false},
        {"managemynode", "preparebudget", &preparebudget, true, true, false},
        {"managemynode", "submitbudget", &submitbudget, true, true, false},
        {"managemynode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"managemynode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"managemynode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"managemynode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"managemynode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"managemynode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"managemynode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"managemynode", "checkbudgets", &checkbudgets, true, true, false},
        {"managemynode", "mnsync", &mnsync, true, true, false},
        {"managemynode", "spork", &spork, true, true, false},
        {"managemynode", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"managemynode", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use managemynoded, or the -server option to managemynode-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> managemynode-cli " + methodname + " " + args + "\n";
}
