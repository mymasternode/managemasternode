                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ManageMyNode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ManageMyNode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and managemynode: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMMN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ManageMyNode Core"), this);
    aboutAction->setStatusTip(tr("Show information about ManageMyNode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ManageMyNode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ManageMyNode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ManageMyNode addresses"));
    ...
    openAction->setStatusTip(tr("Open a ManageMyNode: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ManageMyNode Core help message to get a list with possible ManageMyNode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ManageMyNode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ManageMyNode network", "", count));
}
...
{
    QString strTitle = tr("ManageMyNode Core"); // default title
...
/** Creates context menu, its actions, and managemynodes up all the relevant signals for mouse events. */
