...
public:
    ...
    void setZManageMyNodeControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzMMN_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzMMN_clicked();
    void on_pushButtonZManageMyNodeControl_clicked();
