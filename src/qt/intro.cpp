...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ManageMyNode Core"),
     ...
     * override -datadir in the managemynode.conf file in the default data directory
     * (to be consistent with managemynoded behavior)
     */
    if (dataDir != getDefaultDataDirectory())
