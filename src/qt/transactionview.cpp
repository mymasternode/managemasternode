                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received ManageMyNode from zMMN"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMMN"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMMN));
