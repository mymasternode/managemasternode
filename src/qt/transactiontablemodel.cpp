...
QString TransactionTableModel::formatTxType(const TransactionRecord* wtx) const
{
    ...
    case TransactionRecord::ZerocoinMint:
        return tr("Converted ManageMyNode to zMMN");
    case TransactionRecord::ZerocoinSpend:
        return tr("Spent zMMN");
    case TransactionRecord::RecvFromZerocoinSpend:
        return tr("Received ManageMyNode from zMMN");
    case TransactionRecord::ZerocoinSpend_Change_zMMN:
        return tr("Minted Change as zMMN from zMMN Spend");
    case TransactionRecord::ZerocoinSpend_FromMe:
        return tr("Converted zMMN to ManageMyNode");
