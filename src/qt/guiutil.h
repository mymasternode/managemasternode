...
/** Utility functions used by the ManageMyNode Qt UI.
 */
namespace GUIUtil
{
...
// Render ManageMyNode addresses in monospace font
...
// Parse "managemynode:" URI into recipient object, return true on successful parsing
