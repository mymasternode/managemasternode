...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("ManageMyNode Core managemynode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  managemynode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded managemynode transaction") + "\n" +
                               "  managemynode-tx [options] -create [commands]   " + _("Create hex-encoded managemynode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded managemynode transaction
