...
ManageMyNode now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<managemynode_address\> \<monthly_payment_managemynode\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ ManageMyNode, _12_ times over the course of a year totaling _24000_ ManageMyNode.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<managemynode_address\> \<monthly_payment_managemynode\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` ManageMyNode.
