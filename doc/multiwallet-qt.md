...
In order to support loading of multiple wallets in managemynode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is managemynode.cpp.
...
Changes to managemynode.cpp
----------------------
managemynode.cpp is the entry point into managemynode-qt, and as such, will require some minor modifications to provide hooks for
