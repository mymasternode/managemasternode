Contributing to ManageMyNode Core
============================

The ManageMyNode Core project operates an open contributor model where anyone is
...
The following applies to code changes to the ManageMyNode Core project, and is not to be
confused with overall ManageMyNode Network Protocol consensus changes.

Whether a pull request is merged into ManageMyNode Core rests with the project merge
...
Patches that change ManageMyNode consensus rules are considerably more involved than
...
Where a patch set proposes to change the ManageMyNode consensus, it must have been
...
The project leader is the release manager for each ManageMyNode Core release.
